...
class TunerConstants302
{
    ...
    static constexpr wpi::units::ampere_t kSlipCurrent = 60_A; // 120A
...
public:
    ...
    static constexpr wpi::units::meters_per_second_t kSpeedAt12Volts = 5.12_mps;

private:
    // Every 1 rotation of the azimuth results in kCoupleRatio drive motor turns;
    // This may need to be tuned to your individual robot
    static constexpr wpi::units::scalar_t kCoupleRatio = 3.857142857142857;

    static constexpr wpi::units::scalar_t kDriveGearRatio = 6.026785714285714;
    static constexpr wpi::units::scalar_t kSteerGearRatio = 26.09090909090909;
    static constexpr wpi::units::inch_t kWheelRadius = 1.93_in;
...
private:
    ...
    static constexpr wpi::units::turn_t kFrontLeftEncoderOffset = 0.2919921875_tr;
    static constexpr bool kFrontLeftSteerMotorInverted = false;
    static constexpr bool kFrontLeftEncoderInverted = false;

    static constexpr wpi::units::inch_t kFrontLeftXPos = 9.375_in;
    static constexpr wpi::units::inch_t kFrontLeftYPos = 12.375_in;
    ...
    static constexpr wpi::units::turn_t kFrontRightEncoderOffset = 0.264404296875_tr;
    static constexpr bool kFrontRightSteerMotorInverted = false;
    static constexpr bool kFrontRightEncoderInverted = false;

    static constexpr wpi::units::inch_t kFrontRightXPos = 9.375_in;
    static constexpr wpi::units::inch_t kFrontRightYPos = -12.375_in;

    // Back Left
    static constexpr int kBackLeftDriveMotorId = 23;
    static constexpr int kBackLeftSteerMotorId = 22;
    static constexpr int kBackLeftEncoderId = 22;
    static constexpr wpi::units::turn_t kBackLeftEncoderOffset = -0.31103515625_tr;
    static constexpr bool kBackLeftSteerMotorInverted = false;
    static constexpr bool kBackLeftEncoderInverted = false;

    static constexpr wpi::units::inch_t kBackLeftXPos = -9.375_in;
    static constexpr wpi::units::inch_t kBackLeftYPos = 12.375_in;

    // Back Right
    static constexpr int kBackRightDriveMotorId = 1;
    static constexpr int kBackRightSteerMotorId = 0;
    static constexpr int kBackRightEncoderId = 0;
    static constexpr wpi::units::turn_t kBackRightEncoderOffset = -0.31787109375_tr;
    static constexpr bool kBackRightSteerMotorInverted = false;
    static constexpr bool kBackRightEncoderInverted = false;

    static constexpr wpi::units::inch_t kBackRightXPos = -9.375_in;
    static constexpr wpi::units::inch_t kBackRightYPos = -12.375_in;
