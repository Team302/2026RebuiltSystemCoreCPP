...
public:
    ...
    // This needs to be tuned to your individual robot
    static constexpr wpi::units::meters_per_second_t kSpeedAt12Volts = 4.58_mps;
...
private:
    ...
    static constexpr wpi::units::scalar_t kDriveGearRatio = 6.746031746031747;
    static constexpr wpi::units::scalar_t kSteerGearRatio = 12.8;
...
private:
    ...
    static constexpr wpi::units::turn_t kFrontLeftEncoderOffset = -0.357666015625_tr;
    static constexpr bool kFrontLeftSteerMotorInverted = false;
    static constexpr bool kFrontLeftEncoderInverted = false;

    static constexpr wpi::units::inch_t kFrontLeftXPos = 7_in;
    static constexpr wpi::units::inch_t kFrontLeftYPos = 7_in;
    ...
    static constexpr wpi::units::turn_t kFrontRightEncoderOffset = 0.18212890625_tr;
    static constexpr bool kFrontRightSteerMotorInverted = false;
    static constexpr bool kFrontRightEncoderInverted = false;

    static constexpr wpi::units::inch_t kFrontRightXPos = 7_in;
    static constexpr wpi::units::inch_t kFrontRightYPos = -7_in;

    // Back Left
    static constexpr int kBackLeftDriveMotorId = 13;
    static constexpr int kBackLeftSteerMotorId = 12;
    static constexpr int kBackLeftEncoderId = 12;
    static constexpr wpi::units::turn_t kBackLeftEncoderOffset = 0.30615234375_tr;
    static constexpr bool kBackLeftSteerMotorInverted = false;
    static constexpr bool kBackLeftEncoderInverted = false;

    static constexpr wpi::units::inch_t kBackLeftXPos = -7_in;
    static constexpr wpi::units::inch_t kBackLeftYPos = 7_in;

    // Back Right
    static constexpr int kBackRightDriveMotorId = 15;
    static constexpr int kBackRightSteerMotorId = 14;
    static constexpr int kBackRightEncoderId = 14;
    static constexpr wpi::units::turn_t kBackRightEncoderOffset = -0.199951171875_tr;
    static constexpr bool kBackRightSteerMotorInverted = false;
    static constexpr bool kBackRightEncoderInverted = false;

    static constexpr wpi::units::inch_t kBackRightXPos = -7_in;
    static constexpr wpi::units::inch_t kBackRightYPos = -7_in;
